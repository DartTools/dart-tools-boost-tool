...
os.system(f"title Dart Tools Boost Tool")    
...
def boost_menu():
    print(Fore.GREEN)
    while True:
        choice = input(Fore.RED + "[!] Contiune? (Y/N) ->  " + Style.RESET_ALL)
        if choice.lower() == 'y':
...
def menu():
    invite = input(f"{Style.BRIGHT}{Fore.WHITE}[{Fore.MAGENTA}>{Fore.WHITE}]{Fore.RED} Invite: ")
    if ".gg/" in invite:
    ...
    try:
        months = int(input(f"{Style.BRIGHT}{Fore.WHITE}[{Fore.MAGENTA}>{Fore.WHITE}]{Fore.RED} Months: "))
    except:
    ...
    try:
        amount = int(input(f"{Style.BRIGHT}{Fore.GREEN}{Fore.WHITE}[{Fore.MAGENTA}>{Fore.WHITE}]{Fore.RED} Amount: "))
    except:
    ...
    nick = input(f"{Style.BRIGHT}{Fore.GREEN}{Fore.WHITE}[{Fore.MAGENTA}>{Fore.WHITE}]{Fore.RED} Nickname: ")
    go = time.time()
